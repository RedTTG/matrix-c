...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "bf71a834948186f4097caa076cd2663c69a10e1e"
  WORKING_DIRECTORY "/home/runner/work/matrix-c/matrix-c/build/_deps/glm-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: bf71a834948186f4097caa076cd2663c69a10e1e")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/matrix-c/matrix-c/build/_deps/glm-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/matrix-c/matrix-c/build/_deps/glm-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
